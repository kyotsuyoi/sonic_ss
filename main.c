...
static void reset_to_splash_screen(void)
{
    ...
    player.punch_wram_sprite_id = -1;
    player.damaged_wram_sprite_id = -1;
    player.defeated_wram_sprite_id = -1;
    player2.wram_sprite_id = -1;
    player2.punch_wram_sprite_id = -1;
    player2.damaged_wram_sprite_id = -1;
    player2.defeated_wram_sprite_id = -1;
